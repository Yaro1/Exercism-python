str_ = [
    ...
    "On the fifth day of Christmas my true love gave to me: five Gold Rings, four Calling Birds, three French Hens, "
    ...
    "six Geese-a-Laying, five Gold Rings, four Calling Birds, three French Hens, two Turtle Doves, and a Partridge in "
    "a Pear Tree.",
    "On the ninth day of Christmas my true love gave to me: nine Ladies Dancing, eight Maids-a-Milking, "
    "seven Swans-a-Swimming, six Geese-a-Laying, five Gold Rings, four Calling Birds, three French Hens, two Turtle "
...
def recite(start_verse, end_verse):
    return str_[start_verse-1:end_verse]
